...
dropbox.consumerKey = "demo";
dropbox.consumerSecret = "demo";
...
dropbox.setupoauth = function(userEmail,userPass,success,failure){
    ...
    console.log(userPass);
        var requestURL = "https://api.aspiringapps.com/1/oauth/request_token";
	var authorizeURL = "https://www.aspiringapps.com/1/oauth/authorize";
	var accessURL = "https://api.aspiringapps.com/1/oauth/access_token";
	var loginURL = "https://www.aspiringapps.com/login";
...
dropbox.getMetadata = function(location,success,failure){
	...
	var metaURL = "https://api.aspiringapps.com/1/metadata/"+ dropbox.accessType + "/";
	if(location){
...
dropbox.getAccountInfo = function(){
	var accountInfoURL = "https://api.aspiringapps.com/1/account/info";
...
dropbox.getFile = function(path,success,failure){
	...
	var getURL = "https://api-content.aspiringapps.com/1/files/"+ dropbox.accessType + "/";
	if(path){
		getURL = getURL+path;
	}
...
dropbox.uploadFile = function(path,fileObj,overwrite,success,failure){
    ...
    //upload URL
    var uploadURL="https://api-content.aspiringapps.com/1/files_put/"+ dropbox.accessType + "/";
    if (path!= null && path!=""){
...
dropbox.deletePath = function(path,success,failure){
    ...
    //delete URL
    var deleteURL="https://api.aspiringapps.com/1/fileops/delete";
