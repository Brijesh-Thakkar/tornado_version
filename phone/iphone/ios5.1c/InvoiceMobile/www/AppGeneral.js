...
function showEmailComposer()
{
    ...
    // console.log(workBookObject.sheetArr[currentname].sheetstr.savestr);
    var savestrr = workBookObject.sheetArr[currentname].sheetstr.savestr;
    
    //            alert(val[]);
    //           var csv = JSONtoCSV(val);
    //            console.log(csv);
...
SocialCalc.Callbacks.mustshowprompt = function(coord)
{
    ...
    // do a decision based on device type
    return isDefaultInputPrompt();
}
