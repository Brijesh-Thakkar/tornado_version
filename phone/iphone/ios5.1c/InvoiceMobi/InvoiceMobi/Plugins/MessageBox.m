...
- (void)prompt:(CDVInvokedUrlCommand*)command {
    ...
    {
        //[[prompt textFieldAtIndex:0] setDelegate:self];
        [[prompt textFieldAtIndex:0] resignFirstResponder];
        [[prompt textFieldAtIndex:0] setKeyboardType:UIKeyboardTypeNumberPad];
        UITextField *tf = NULL;
    ...
    if ([[type lowercaseString] isEqualToString:@"numbersandpunctuation"])
    {
        //[[prompt textFieldAtIndex:0] setDelegate:self];
        [[prompt textFieldAtIndex:0] resignFirstResponder];
        [[prompt textFieldAtIndex:0] setKeyboardType:UIKeyboardTypeNumbersAndPunctuation];
        UITextField *tf = NULL;
        tf = [prompt textFieldAtIndex:0];
        [tf setText:textvalue];
        [[prompt textFieldAtIndex:0] becomeFirstResponder];
    ...
    if ([[type lowercaseString] isEqualToString:@"decimalpad"])
    {
        //[[prompt textFieldAtIndex:0] setDelegate:self];
        [[prompt textFieldAtIndex:0] resignFirstResponder];
        [[prompt textFieldAtIndex:0] setKeyboardType:UIKeyboardTypeDecimalPad];
        UITextField *tf = NULL;
        tf = [prompt textFieldAtIndex:0];
        [tf setText:textvalue];
        [[prompt textFieldAtIndex:0] becomeFirstResponder];
    ...
    if ([[type lowercaseString] isEqualToString:@"namephonepad"])
    {
        //[[prompt textFieldAtIndex:0] setDelegate:self];
        [[prompt textFieldAtIndex:0] resignFirstResponder];
        [[prompt textFieldAtIndex:0] setKeyboardType:UIKeyboardTypeNamePhonePad];
        UITextField *tf = NULL;
        tf = [prompt textFieldAtIndex:0];
        [tf setText:textvalue];
        [[prompt textFieldAtIndex:0] becomeFirstResponder];
    ...
    if ([[type lowercaseString] isEqualToString:@"text"])
    {
        //[[prompt textFieldAtIndex:0] setDelegate:self];
        [[prompt textFieldAtIndex:0] resignFirstResponder];
        [[prompt textFieldAtIndex:0] setKeyboardType:UIKeyboardTypeDefault];
        UITextField *tf = NULL;
        tf = [prompt textFieldAtIndex:0];
        [tf setText:textvalue];
        [[prompt textFieldAtIndex:0] becomeFirstResponder];
