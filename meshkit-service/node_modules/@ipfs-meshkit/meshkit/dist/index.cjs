...
__export(src_exports, {
  ...
  MeshkitNodeError: () => MeshkitNodeError,
  ...
  startIPFSNode: () => startIPFSNode,
  stopIPFSNode: () => stopIPFSNode,
...
function resolveRepoPath(repo = DEFAULT_REPO) {
  return (0, import_node_path.resolve)(repo);
}
...
async function repoExists(repo) {
  try {
    await (0, import_promises.access)((0, import_node_path2.join)(repo, "config"));
    return true;
  } catch {
    return false;
  }
...
async function assertIpfsBinary(binary) {
  await new Promise((resolve2, reject) => {
    const child = (0, import_node_child_process2.spawn)(binary, ["--version"], { stdio: ["ignore", "ignore", "pipe"] });
    child.once("error", (error) => {
      reject(
        new MeshkitNodeError(
...
function spawnKuboDaemon(binary, options) {
  return (0, import_node_child_process2.spawn)(binary, ["daemon"], {
