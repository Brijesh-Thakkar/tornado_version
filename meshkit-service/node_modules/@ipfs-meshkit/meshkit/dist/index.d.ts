...
declare class MeshkitNodeError extends Error {
    constructor(message: string, options?: {
        cause?: unknown;
    });
}
interface StartIPFSNodeOptions {
    /**
...
declare const DEFAULT_REPO = ".ipfs";
/** Resolve a repo path to an absolute filesystem path. */
declare function resolveRepoPath(repo?: string): string;

/**
 * List all pinned CIDs on a Kubo node. Useful for migration scripts and backups.
 */
declare function listPins(apiUrl: string): Promise<string[]>;
 ...
 */
declare function startIPFSNode(options?: StartIPFSNodeOptions): Promise<IPFSNodeHandle>;
/** Stop a node handle returned by {@link startIPFSNode}. */
declare function stopIPFSNode(handle: IPFSNodeHandle): Promise<void>;

type LocalNodeOption = boolean | StartIPFSNodeOptions;
interface MeshkitBootstrapOptions extends Omit<MeshkitInitOptions, 'nodes'> {
    /**
...
interface MeshkitBootstrapResult {
 ...
 */
declare function init(options?: MeshkitBootstrapOptions): Promise<MeshkitBootstrapResult>;
 ...
 */
declare function setupGracefulShutdown(localNode: IPFSNodeHandle | undefined, options?: GracefulShutdownOptions): void;

export { DEFAULT_REPO, type FilOneConfig, type GracefulShutdownOptions, type IPFSNodeHandle, IPNS_TTL_DEFAULT, IPNS_TTL_FAST, type IpnsDuration, type IpnsKey, type IpnsKeyGenOptions, type IpnsPublishOptions, type IpnsPublishResult, type IpnsResolveOptions, type LocalNodeOption, Meshkit, type MeshkitBootstrapOptions, type MeshkitBootstrapResult, type MeshkitClient, type MeshkitConfig, MeshkitError, type MeshkitInitOptions, MeshkitNodeError, type S3StorageConfig, type StartIPFSNodeOptions, type StoredObject, createFilOneClient, createMeshkitClient, createS3Client, extractCidFromPath, init, listPins, resolveRepoPath, setupGracefulShutdown, startIPFSNode, stopIPFSNode, toIpfsPath, toIpnsPath };
